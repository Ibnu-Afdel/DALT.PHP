...
final class Session
{
    ...
    public static function get(string $key, mixed $default = null): mixed
    {
        ...
        // BUG: persistent data wins over flash data with the same key.
        return array_key_exists($key, $_SESSION) ? $_SESSION[$key] : self::getFlash($key, $default);
    }
    ...
    public static function ageFlashData(): void
    {
        ...
        // BUG: old data is carried forward, so a flash value never expires.
